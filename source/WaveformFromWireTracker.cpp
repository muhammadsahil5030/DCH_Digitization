...
///////////////////////////////////////////////////////////////////////////////////////
/////////////////       WaveformFromWireTracker constructor       /////////////////////
///////////////////////////////////////////////////////////////////////////////////////
...
StatusCode WaveformFromWireTracker::initialize() 
{
  ...
  info() << "[WaveformFromWireTracker] m_halfChamberLength_mm = " << m_halfChamberLength_mm << " mm" << endmsg;
...
std::tuple<
	...
	edm4hep::RawTimeSeriesCollection>
WaveformFromWireTracker::operator()(const edm4hep::SimTrackerHitCollection& input_cluster_hits,
		const edm4hep::EventHeaderCollection&   headers) const 
{
  ...
  for (const auto& input_cluster_hit : input_cluster_hits) 
  {
    ...
    auto hit_position = Convert_EDM4hepVector_to_TVector3(
		    input_cluster_hit.getPosition(), MM_TO_CM);
    ...
    // Sample the number of electrons associated with this gas-ionization cluster.
...
//====================================================================================
    ...
    electron_wireZ_mm.reserve(Ne_cluster);
    ...
    TVector3 cl_to_wire = this->dch_data->Calculate_hitpos_to_wire_vector(    
		    hit_ilayer, hit_nphi, cluster_pos);

    // Compute projected cluster position on the wire
    TVector3 cl_on_wire = cluster_pos + cl_to_wire;

    // z coordinate of projected point on the wire in mm
...
//======================================================================================= 			
    ...
    // Absolute time of this gas cluster.
...
//===============================================================================================//
//                          END OF DIGITIZED WAVEFORM PRODUCTION                                 //
//===============================================================================================//
